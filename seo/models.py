...
class AbstractBaseSeoModel(models.Model):
    ...
    def get_metadata(self):
        ...
        return MetadataModel.objects.filter(content_type=content_type.pk, object_id=self.pk)

    def get_search_engine_title(self):
    ...
    @property
    def get_search_engine_description(self):
    ...
    @property
    def get_search_engine_keywords(self):
